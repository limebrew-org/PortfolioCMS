...
ExperienceRouter.post(
	"/internship/add",
	TokenMiddleWare,
	experienceController.addInternship
)
ExperienceRouter.put(
	"/internship/update/:id",
	TokenMiddleWare,
	experienceController.updateInternshipById
)
...
ExperienceRouter.delete(
	"/internship/delete",
	TokenMiddleWare,
	experienceController.deleteAllInternships
)
...
ExperienceRouter.put(
	"/job/update/:id",
	TokenMiddleWare,
	experienceController.updateJobById
)
ExperienceRouter.delete(
	"/job/delete/:id",
	TokenMiddleWare,
	experienceController.deleteJobById
)
ExperienceRouter.delete(
	"/job/delete",
	TokenMiddleWare,
	experienceController.deleteAllJobs
)

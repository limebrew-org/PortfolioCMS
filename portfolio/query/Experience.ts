...
class ExperienceQuery {
    ...
    static async getMany(query: ExperienceQueryType, schema: "Internship"|"Job"): Promise<ResponseBodyType> {
    ...
    static async getOne(query: ExperienceQueryType, schema: "Internship"|"Job"): Promise<ResponseBodyType> {
        //? Declare the entity to be stored
    ...
    static async addOne(experienceInfo: ExperienceFieldType, schema: "Internship"|"Job"): Promise<ResponseBodyType> {
         //? Declare the entity to be stored
    ...
    static async updateById(
        ...
        //? Declare the entity to be stored
        const existingExperienceEntityResponse: ResponseBodyType = await ExperienceQuery.getOne({
            _id: id,
    ...
    static async deleteById(
		...
		const existingExperienceEntityResponse: ResponseBodyType =
			await ExperienceQuery.getOne({ _id: id, profile_id: profile_id }, schema)
	...
	static async deleteMany(profile_id: String, schema: "Internship"|"Job"): Promise<ResponseBodyType> {
